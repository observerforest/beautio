...
const english: Readonly<Record<string, string>> = {
  ...
  "邮箱 / 手机号": "Email / phone",
  "账户登录即将开放": "Account sign-in is not available yet",
  ...
  "已归档": "Archived",
  "愿望清单": "Wishlist",
  "愿望清单即将开放": "Wishlist is not available yet",
  ...
  "护肤知识即将开放": "Skincare knowledge is not available yet",
  "账户信息": "Account",
  "通知设置": "Notifications",
  "数据备份": "Data backup",
  "隐私政策": "Privacy policy",
  ...
  "本说明描述当前版本的实际行为；公开注册、多人数据隔离和通知功能尚未开放。":
    "This notice describes the current version. Public registration, multi-user data isolation, and notifications are not available yet.",
  ...
  "清除筛选": "Clear filters",
  "刷新": "Refresh",
  "添加产品即将开放": "Add product is not available yet",
  "添加产品": "Add product",
